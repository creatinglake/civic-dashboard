...
export function ExternalView({ url, title, onBack, isHub }) {
  ...
  return (
    <>
      <SlimSidebar onBack={onBack} destination={title} />
          ...
          <div className="h-full flex flex-col items-center justify-center bg-civic-cream p-8">
            <div className="max-w-md text-center">
              ...
              <p className="text-sm text-civic-green/50 mt-6">
                Click the back button in the slim sidebar to return to the dashboard.
              </p>
            </div>
          </div>
        ) : (
